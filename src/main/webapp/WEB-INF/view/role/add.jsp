  ...
  <body>
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form" id="myform">
				  ...
				  <button type="button" onclick="sub_addrole()" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 新增</button>
	...
	<script src="../script/docs.min.js"></script>
        <script type="text/javascript">
            ...
            //新增
            function sub_addrole(){
            	var name=$("#name").val();
            	$.ajax({
             		type:"post",
             		url:baseUrl+"/rc/addrole",
             		data:{
             			name:name
             		},
             		dataType:'text',
             		success:function(result){
             			if(result=='ok'){
             				alert("新增成功")
             				 window.location.href="/rc/getRole"; 
             			}else{
             				alert("新增失败")
             			}
             		}
